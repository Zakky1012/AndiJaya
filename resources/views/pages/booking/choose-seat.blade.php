                ...
                <div class="relative flex flex-col justify-end">
                    <form action="{{ route('booking.confirmSeat', $keberangkatan->nomor_keberangkatan) }}" method="POST" class="relative px-[56px] pb-[60px]" id="form-seat">
                        ...
                        <div id="Seats-Options"
                            class="flex flex-wrap w-full @if ($tier->tipe_kelas == 'premium') gap-10 px-[33px] @else gap-x-[14px] @endif">
                            @foreach ($keberangkatan->seats->where('tipe_kelas', $tier->tipe_kelas) as $seat)
                                <label
