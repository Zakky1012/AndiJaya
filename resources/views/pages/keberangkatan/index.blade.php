        ...
        <div class="flex gap-[26px] mt-[30px]">
            <form id="Filter" action="#"
                ...
                <div id="Flights" class="flex flex-col gap-4">
                    <p class="font-semibold">Keberangkatan</p>
                    ...
                    @if ($keberangkatan->segments->count() > 2)
                        ...
                        <label class="accordion-trigger flex items-center justify-between">
                            ...
                            <div class="flex flex-col gap-[2px] items-center justify-center">
                                ...
                                <p class="text-sm text-garuda-grey">Transit {{ $keberangkatan->segments->count() - 2 }}x</p>
                            </div>
                        ...
                        <div class="accordion-content flex justify-between">
                            <div class="left-content flex flex-col gap-[10px]">
                                @foreach ($keberangkatan->segments as $segment)
                                    <div
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold">
                                                    {{ $segment->destinasi->kota }} (
                                                        {{ $segment->destinasi->iata_code }}
                                                    )
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    @if (!$loop->last)
                                        <div class="time flex flex-col items-center w-[83px]">
                                            ...
                                            <p class="text-xs leading-[18px] text-garuda-grey">
                                                {{ number_format($segment->time->diffInHours($keberangkatan->segments[$loop->index + 1]->time), 0) }}
                                                hours
                                            </p>
                                            <div class="h-8 border border-garuda-black border-dashed"></div>
                                        </div>
                            ...
                            <div
                                ...
                                @foreach ($keberangkatan->classes as $class)
                                    @foreach ($class->facilities as $fasilitas)
                            ...
                            <div class="left-content flex flex-col gap-[10px]">
                                ...
                                <div class="arrival flex items-center gap-5">
                                    <div class="text-center w-[83px]">
                                        ...
                                        <p class="text-sm text-garuda-grey mt-[2px]">
                                            {{ $keberangkatan->segments->last()->time->format('d F Y') }}
                                        </p>
                                    </div>
                                    <div class="flex items-center gap-4">
                                        <img src="{{ asset('assets/images/icons/arrival.svg') }}" class="w-[50px] h-[50px] flex shrink-0"
                                            alt="icon">
                                        <div>
