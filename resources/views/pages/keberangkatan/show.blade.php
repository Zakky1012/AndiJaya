    ...
    <main class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto mt-[50px] mb-[62px]">
        ...
        <div class="flex gap-[30px] mt-[30px]">
            ...
            <form  action="{{ route('booking', $keberangkatan->nomor_keberangkatan) }}" id="Tiers" class="grid grid-cols-2 gap-x-[30px]">
                <input type="hidden" name="keberangkatan_class_id" value="" id="keberangkatan_class_id">
                @foreach ($keberangkatan->classes as $class)
                    <div class="flex flex-col h-fit rounded-[20px] p-5 pb-[30px] gap-5 bg-white">
                        ...
                        <button
                            class="w-full rounded-full py-3 px-5 text-center bg-garuda-blue hover:shadow-[0px_14px_30px_0px_#0068FF66] transition-all duration-300" onclick="document.getElementById('keberangkatan_class_id').value = {{ $class->id }}">
